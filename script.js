...
function showIpDetails(ip,lat, long, data){
 ...
 const map = document.getElementById('map')
  map.innerHTML = `<iframe src="https://maps.google.com/maps?q= ${lat}, ${long}&z=15&output=embed" width="100%" height="100%" frameborder="5" style="border:1"></iframe>`
...
// displaying time zone
 function showTimezone(timeZone, pincode){
    ...
    timZone.innerHTML =`<div><span id="time">Time Zone: ${timeZone}</span></div>
